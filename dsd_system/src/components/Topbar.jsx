...
export default function Topbar({ pageTitle, breadcrumb, onNewEntry }) {
  const { role, setRole, currentUser } = useData();
  ...
  return (
    <header className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="inline-flex items-center gap-1.5 rounded-md border border-gray-300 bg-white px-3.5 py-1.5 text-sm text-gray-600 hover:bg-gray-50">
          <Filter size={14} />
          Filter
        </button>
